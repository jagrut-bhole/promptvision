...
// import {Background1,Background2,Background3} from '../../public/images'
...
//       style={{ height: '300vh' }}
//     >
//       <section id="how-it-works" className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white">
...
const HowItWorks = () => {
  ...
  return (
    <div ref={sectionRef} className="relative" style={{ height: "300vh" }}>
      <section
        className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden dark:bg-gray-900/80"
        id="how-it-works"
      >
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
