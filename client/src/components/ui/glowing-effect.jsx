...
const GlowingEffect = memo(({
  ...
  borderWidth = 1,
  disabled = false // ⚠️ Changed default to false
}) => {
  ...
  const handleMove = useCallback((e) => {
    ...
    animationFrameRef.current = requestAnimationFrame(() => {
      ...
      // Simple animation without motion/react dependency
      ...
      const animateAngle = (currentTime) => {
        ...
        const currentValue = startAngle + (newAngle - startAngle) * eased;
        
        currentAngleRef.current = currentValue;
